...
export function GovernanceTopbar({ title }: GovernanceTopbarProps) {
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-card/95 backdrop-blur-sm border-b border-border z-10">
      <div className="h-full px-6 flex items-center justify-between ml-0 md:ml-64">
        ...
        <div className="flex-1 max-w-xl mx-6 hidden md:block">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Cari data, prediksi, regulasi..."
            ...
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-3 hover:bg-muted px-3 py-2 rounded-xl transition-all">
                ...
                <div className="text-left hidden md:block">
                  <p className="text-sm">Dr. Habibirrohim</p>
